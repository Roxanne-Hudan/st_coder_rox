...
--
-- Table structure for table `vacaciones_tecnicos`
--

DROP TABLE IF EXISTS `vacaciones_tecnicos`;
...
CREATE TABLE `vacaciones_tecnicos` (
  ...
  CONSTRAINT `vacaciones_tecnicos_ibfk_1` FOREIGN KEY (`id_tecnico`) REFERENCES `tecnicos` (`id_tecnico`)

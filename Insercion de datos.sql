...
-- importación de 1.- tecnicos_DATA
INSERT INTO tecnicos (nombre, apellido, fecha_de_ingreso, email)
VALUES ('Antonio', 'Criollo', '2018-01-10', 'acriollo@gmail.com');

-- importación de 2.-clientes_DATA 
INSERT INTO clientes (unidad, razon_social)
VALUES ('Chilis Zona Rosa', 'Gastrosur');
...
-- delete from base_de_servicio
-- where numero_servicio = 1 
-- TRUNCATE TABLE base_de_servicio;
...
VALUES (1,1,'2025-09-01','Mantenimiento preventivo'),
	   (1,13,'2025-09-02','Mantenimiento preventivo'),
